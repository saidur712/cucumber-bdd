...
public class SearchResultPage extends PageHelper {
    ...
    private final By searchResultTileLocator = By.cssSelector(".product_list .product-name");
    private final By priceLocator = By.cssSelector(".right-block div[itemprop='offers'] span[itemprop='price']");
